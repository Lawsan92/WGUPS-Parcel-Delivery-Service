...
# initialize trucks
truck_1 = truck.Truck(1, [1, 13, 14, 15, 16, 20, 40, 2, 3, 4, 5, 7, 8, 11, 12, 21], datetime.timedelta(hours=8))
truck_2 = truck.Truck(2, [3, 6, 36, 39, 25, 29, 30, 31, 32,  34, 36, 37, 39, 17, 18, 19, 22, 23, 24], datetime.timedelta(hours=9, minutes=5))
truck_3 = truck.Truck(3,[], datetime.timedelta(hours=8))
